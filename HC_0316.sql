...
('冰美式咖啡 Iced Caffè Americano','/img/冰美式咖啡.jpg','110','以歐洲方式調製，帶來濃郁豐富的咖啡滋味。','1'),
...
('可可綿雲瑪奇朵 Cocoa Cloud Macchiato','/img/可可綿雲瑪奇朵.jpg','155','輕柔的雲朵泡沫結合經典濃縮咖啡與濃醇的巧克力，尾韻帶有些微香草甜美，豐富的層次帶給您多重的味蕾享受。','1'),
('冰可可綿雲瑪奇朵 Iced Cocoa Cloud Macchiato','/img/冰可可綿雲瑪奇朵.jpg','155','輕柔的雲朵泡沫結合經典濃縮咖啡與濃醇的巧克力，尾韻帶有些微香草甜美，豐富的層次帶給您多重的味蕾享受。','1'),
('可可瑪奇朵 Cocoa Macchiato','/img/可可瑪奇朵.jpg','155','第一口綿密香醇的奶泡混合著香甜可可的糖醬滋味，搭配經典義式濃縮咖啡，層次堆疊滿足味蕾的享受。感受猶如奶油般柔滑口感及細緻可可香氣。','1'),
('冰可可瑪奇朵 Iced Cocoa Macchiato','/img/冰可可瑪奇朵.jpg','155','第一口綿密香醇的奶泡混合著香甜可可的糖醬滋味，搭配經典義式濃縮咖啡，層次堆疊滿足味蕾的享受。感受猶如奶油般柔滑口感及細緻可可香氣。','1'),
('雲朵冰搖濃縮咖啡 Cold Foam Iced Espresso','/img/雲朵冰搖濃縮咖啡.jpg','145','創新的現煮義式飲品!滿足咖啡饕客的咖啡味蕾。綿滑香柔的雲朵(冰奶泡)是由低脂牛奶打製而成，倒入杯中後再添加手工搖製，濃郁香醇的冰搖濃縮咖啡，在冰鎮清爽的滋味中，品嘗兩者交織出的驚喜風味！','1'),
...
('冰特選馥郁那堤 Espresso Choice Extra Shot Iced Latte','/img/冰特選馥郁那堤.jpg','160','精心為您挑選來自不同產區的濃縮咖啡，並選擇使用較多份的濃縮咖啡增加濃醇度，搭配牛奶凸顯咖啡甜感，帶給您多元的牛奶咖啡風味。','1'),
...
('冰馥列白 Iced Flat White','/img/冰馥列白.jpg','150','此款咖啡源由自與亞洲相鄰，精品咖啡文化紮實的澳洲，在濃縮咖啡與牛奶的比例上，選擇使用較多份的ristretto shots 短濃縮增加咖啡濃醇度的同時並凸顯咖啡甜感，由漂亮的圓點結束，完成一杯風味較濃郁且平衡的牛奶咖啡。','1');
...
INSERT INTO `blogs`(`fk_type_id`,`title`,`content`)
VALUES
...
而白咖啡的咖啡豆，多以中輕度低溫烘培至出現焦糖香氣而製成，沖調時再搭配絲滑綿密的細緻奶泡、以及香濃的蒸汽熱牛奶，入口油脂飽滿且富含焦糖甜香，整體滑順回甘、風味輕柔，在世界各地皆擁有一票白咖啡的忠實愛好者，從獨立咖啡店到各大連鎖咖啡廳都能見到其蹤跡，絕對是一款香醇又非常順口的咖啡選擇！'),
...
賴昱權與咖啡命定的相遇，打造出了不凡的人生態度。他說：「人可以不完美，但一定要特別。」別人看他是瘋子，因為他全心全意地投入；別人笑他是傻子，因為他堅持不放手；別人說他野心大，但他只是將咖啡化作生命的信仰，往夢想奔近。'),
...
不亞於手沖咖啡的濾掛咖啡包，有了世界冠軍咖啡大師的把關、iDrip 的獨家設計、以及各界人士的強力推薦，更讓 iDrip 濾掛咖啡包成為生活新品味，隨時隨地都能擁有一杯完美的精品好咖啡！');
...
VALUES
('1','/imags/blog-coffee/01.png','blog-coffee-photo001'),
('2','/imags/blog-coffee/02.png','blog-coffee-photo002'),
('3','/imags/blog-coffee/02.png','blog-coffee-photo003'),
('4','/imags/blog-coffee/02.png','blog-coffee-photo004'),
('5','/imags/blog-coffee/02.png','blog-coffee-photo005');
