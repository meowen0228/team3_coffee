            ...
            <div class="col-10">
                ...
                <div class="accordion accordion-flush" id="accordionFlushExample">
                    <div class="accordion-item nonship">
                        <h2 class="accordion-header" id="flush-heading<?php $n ?>">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapse<?php $n ?>" aria-expanded="false" aria-controls="flush-collapse<?php $n ?>">
                        ...
                        <div id="flush-collapse<?php $n ?>" class="accordion-collapse collapse" aria-labelledby="flush-heading<?php $n ?>" data-bs-parent="#accordionFlushExample">
