...
<main class="admin-main px-5 py-5">
    ...
    <div class="col-10 userMain">
        ...
        <div class="row askArea">
            ...
            <div class="col-3"></div>
            <div class="col-6 ">
            <textarea name="ans" id="ans" class="ansInput"  cols="45" rows="4" ><?= $row['ans'] ?></textarea>
             </div>
            <div class="col-3"></div>
        </div>
    ...
    <script>
        ...
        if(isPass){
            ...
            .then(obj => {
                ...
                if(obj.success){
                    alert('成功回復');
                    location.href = 'user_ask-bd-yes.php';
                } else {
                    alert('回復失敗');
                    location.href = 'user_ask-bd-no.php';
                }
